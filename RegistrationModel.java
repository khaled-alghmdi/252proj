...
public class RegistrationModel extends Observable {
    ...
    public RegistrationModel() {
        ...
        database = new DatabaseProxy(); // استخدام البروكسي
    }
    ...
    public void addUser(User user) {
        ...
        database.writeToFile("students.txt", user.getRole() + "," + user.getUsername(), true);
    ...
    public void addCourse(Course course) {
        ...
        database.writeToFile("courses.txt", course.getCourseId() + "," + course.getCourseName(), true);
    ...
    public void registerForCourse(String studentName, String courseId) {
        if (registrations.contains(studentName + "," + courseId)) {
        ...
        database.writeToFile("registrations.txt", studentName + "," + courseId, true);
